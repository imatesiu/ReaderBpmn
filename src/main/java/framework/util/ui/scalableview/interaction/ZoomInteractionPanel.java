...
public class ZoomInteractionPanel extends JPanel implements ViewInteractionPanel {
	...
	public ZoomInteractionPanel(ScalableViewPanel panel, int maximumZoom) {
		...
		this.slider = new JSlider(1);// SlickerFactory.instance().createSlider(1);
		...
		this.sliderMinValue = new JLabel("0%");// SlickerFactory.instance().createLabel("0%");
		this.sliderMaxValue =  new JLabel(maximumZoom + "%");//SlickerFactory.instance().createLabel(maximumZoom + "%");
		this.sliderFitValue = new JButton("Fit >"); //SlickerFactory.instance().createButton("Fit >");
		...
		this.sliderValue =new JLabel(fitZoom + "%");// SlickerFactory.instance().createLabel(fitZoom + "%");
