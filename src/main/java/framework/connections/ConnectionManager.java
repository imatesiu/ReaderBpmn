...
import framework.plugin.events.ConnectionObjectListener;
...
public interface ConnectionManager {
	 ...
	 */
	<T extends Connection> Collection<T> getConnections(Class<T> connectionType,
	 ...
	 *             produced in the given context.
	 */
	<T extends Connection> T getFirstConnection(Class<T> connectionType, Object... objects)
			throws ConnectionCannotBeObtained;
