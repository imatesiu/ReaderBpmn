...
public class CustomGraphPort extends DefaultPort implements Cleanable, ModelOwner, CustomGraphElement {
	...
	public CustomGraphPort(Object userObject, CustomGraphModel model, GraphLayoutConnection layoutConnection) {
		super(userObject);
		this.model = model;
